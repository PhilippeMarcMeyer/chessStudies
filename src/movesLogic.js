      ...
      if(!nextMoveData.isError){
        ...
        if(nextMoveData.movePieceType === "p"){
          if(nextMoveData.moveRow === 4 && nextMoveData.moveSide === "w" && nextMoveData.moveType === "move"){
            ...
            nextMoveData.possiblePositions.push({"column":nextMoveData.moveColumn,"row":nextMoveData.moveSide === "w" ? nextMoveData.moveRow-1 :nextMoveData.moveRow+1 });
          }else if(nextMoveData.moveType === "take"){
          // toDo : en passant

          // mundane take :
          if(nextMoveData.comingFromColumn !== ""){
            nextMoveData.possiblePositions.push({"column":nextMoveData.comingFromColumn,"row":nextMoveData.moveSide === "w"?nextMoveData.moveRow-1 :nextMoveData.moveRow+1 });
          }else{
            ...
            if(posMoveColumn === 0){ // pawn takes on "a" file : only one possibility, it's on "b" file
              nextMoveData.possiblePositions.push({"column":columnsOrdered[1],"row":nextMoveData.moveSide === "w"?nextMoveData.moveRow-1 :nextMoveData.moveRow+1 });
            }else if(posMoveColumn === 7){// pawn takes on "h" file : only one possibility, it's on "g" file
              nextMoveData.possiblePositions.push({"column":columnsOrdered[6],"row":nextMoveData.moveSide === "w"?nextMoveData.moveRow-1 :nextMoveData.moveRow+1 });
            }else{ // 2 possibilities the pawn is either coming from the left side or the right side of the taken piece column
              nextMoveData.possiblePositions.push({"column":columnsOrdered[posMoveColumn-1],"row":nextMoveData.moveSide === "w"?nextMoveData.moveRow-1 :nextMoveData.moveRow+1 });
              nextMoveData.possiblePositions.push({"column":columnsOrdered[posMoveColumn+1],"row":nextMoveData.moveSide === "w"?nextMoveData.moveRow-1 :nextMoveData.moveRow+1 });
            }
          }
        }else{
